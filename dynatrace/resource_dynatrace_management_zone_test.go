...
func testAccCheckDynatraceManagementZoneExists(n string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		_, _, err := dynatraceConfigClientV1.ManagementZonesApi.GetSingleManagementZoneConfig(authConfigV1, managementZoneID, &dynatraceConfigV1.GetSingleManagementZoneConfigOpts{})
		if err != nil {
			return err
		}
